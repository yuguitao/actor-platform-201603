...
public class VideoGridLayout extends ViewGroup {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        int childWidthSpecs = MeasureSpec.makeMeasureSpec(mChildWidth,
                MeasureSpec.EXACTLY);
        int childHeightSpecs = MeasureSpec.makeMeasureSpec(mChildHeight,
                MeasureSpec.EXACTLY);
        int zoomedWidthSpecs = MeasureSpec.makeMeasureSpec(
                2 * mChildWidth, MeasureSpec.EXACTLY);
        int zoomedHeightSpecs = MeasureSpec.makeMeasureSpec(
                2 * mChildHeight, MeasureSpec.EXACTLY);
